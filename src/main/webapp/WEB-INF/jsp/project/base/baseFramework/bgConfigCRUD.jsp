...
<link rel="stylesheet"
	href="${ctx }/static/project/base/style/css/${fgConfig.defaultTheme }/baseFramework/bgConfigCRUD.css"></link>
<title></title>
</head>
<body>
	<input type="hidden" id="B.BgConfig"
		value='<spring:message code="B.BgConfig"/>' />
	...
	<div id="bgConfigCRUDGrid" style="display: none" class="base-main-grid"></div>

	<script type="text/javascript"
		src="${ctx}/static/project/base/js/baseFramework/bgConfigCRUD.js"></script>
