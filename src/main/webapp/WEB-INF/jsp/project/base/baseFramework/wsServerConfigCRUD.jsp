...
<link rel="stylesheet"
	href="${ctx}/static/project/base/style/css/${fgConfig.defaultTheme}/baseFramework/wsServerConfigCRUD.css"></link>
<title></title>
</head>
<body>

	<input type="hidden" id="B.WsServerConfig"
		value='<spring:message code="B.WsServerConfig"/>' />
	...
	<div id="wsServerConfigCRUDGrid" style="display: none"
		class="base-main-grid"></div>

	<script type="text/javascript"
		src="${ctx}/static/project/base/js/baseFramework/wsServerConfigCRUD.js"></script>
