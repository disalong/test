...
<body>
	...
	<input type="hidden" id="B.Session"
		value='<spring:message code="B.Session"/>' />
	...
	<div id="sessionCRUDGrid" style="display: none" class="base-main-grid"></div>

	<script type="text/javascript"
		src="${ctx}/static/project/base/js/baseSession/sessionCRUD.js"></script>
