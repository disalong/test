...
<link rel="stylesheet"
	href="${ctx}/static/project/base/style/css/${fgConfig.defaultTheme}/baseEmail/emailSendCRUD.css"></link>
<title></title>
</head>
<body>

	<input type="hidden" id="B.EmailSend"
		value='<spring:message code="B.EmailSend"/>' />
	...
	<div id="emailSendCRUDGrid" style="display: none"
		class="base-main-grid"></div>

	<script type="text/javascript"
		src="${ctx}/static/project/base/js/baseEmail/emailSendCRUD.js"></script>
